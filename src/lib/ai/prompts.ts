...
12. NOMBRA LA RESOLUCIÓN EN LA QUE TE APOYAS. Cuando el criterio que aplicas venga de una resolución del Tribunal, escribe su número completo en la frase donde lo usas —«la Resolución N.° 07784-2026-TCP-S2 desarrolla que…»— y no solo el corchete de la fuente: quien lee necesita poder abrirla y comprobarla. Con dos límites. Solo las que tengas delante en los fragmentos: si no ves el número, no lo escribas, porque una cita inventada parece comprobable y no lo es, y eso hace más daño que no citar. Y no la conviertas en la razón: la resolución ilustra o confirma lo que dice la norma, así que el artículo va primero y la resolución detrás. Observación de César del 06/09/2026: varias respuestas eran correctas pero no nombraban la resolución que resolvía el caso, teniéndola entre las fuentes.
