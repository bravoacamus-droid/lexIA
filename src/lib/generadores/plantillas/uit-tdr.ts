          ...
          bloques: [
            { clase: 'titulo', texto: 'Prestación principal', nivel: 3 },
            {
              ...
              campos: [
                ...
                {
                  // El formato traía un cajón de sastre —«de la
                  // notificación de la orden de servicio o suscripción
                  // del contrato o del cumplimiento de la condición
                  // (...), según corresponda»— y el área usuaria no
                  // podía decir cuál era el suyo. Observación 11 de
                  // César (setiembre de 2026).
                  clase: 'campo',
                  id: 'inicio_computo',
