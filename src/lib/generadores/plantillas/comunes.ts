...
// ════════════════════════════════════════════════════════════════════
// Métodos de los requisitos de calificación — observaciones 22 a 31
// ════════════════════════════════════════════════════════════════════
//
// Todas comparten la misma preocupación de César, dicha diez veces: no
// establecer nada "por defecto", no inventar, y no confundir lo que es
// condición de ejecución con lo que decide quién puede presentarse a la
// convocatoria. Cada exigencia de más aquí restringe la competencia.

export const METODO_PERSONAL_CLAVE =
  ' Antes de nada, determina si por la naturaleza, complejidad o especialidad de esta contratación hace falta identificar personal clave: si la prestación puede ejecutarse bien sin identificarlo, dilo y no lo establezcas. Si corresponde, precisa de cada uno solo lo necesario: el cargo o responsabilidad en la ejecución, las actividades principales directamente vinculadas a la prestación y, únicamente cuando haga falta y esté ligada a sus funciones, la capacitación. Comprueba que cada persona sea realmente indispensable, que sus responsabilidades se relacionen con el objeto y que no dupliquen actividades u obligaciones ya establecidas. No inventes cargos, responsabilidades, actividades, capacitaciones ni perfiles que no estén sustentados en lo que se te ha dado, y no conviertas en requisito de calificación lo que solo es condición de ejecución.';

export const METODO_PERSONAL_NO_CLAVE =
  ' Antes de nada, determina si la ejecución necesita personal de apoyo, operativo, técnico o administrativo expresamente identificado: si no lo necesita, dilo y no lo establezcas. Si corresponde, precisa de cada cargo solo lo necesario: cargo o responsabilidad; cantidad, cuando haga falta; profesión, formación académica o grado o título, según corresponda; experiencia mínima, cuando resulte necesaria; y capacitación, cuando la exija el desempeño de sus funciones. Cada exigencia debe guardar relación directa con las funciones, ser objetiva, necesaria, razonable, proporcional y verificable, y no duplicar al personal clave ni las obligaciones del contratista. No inventes cargos, cantidades, profesiones, grados, títulos, experiencia ni capacitaciones, y no conviertas en requisito de calificación lo que solo es condición de ejecución.';

export const METODO_EQUIPAMIENTO_NO_ESTRATEGICO =
  ' Antes de nada, determina si la ejecución necesita equipamiento no estratégico: si puede ejecutarse bien sin identificarlo, dilo y no lo establezcas. Si corresponde, precisa la relación de equipos necesarios, la cantidad de cada uno cuando haga falta y SOLO DE DOS A TRES características técnicas esenciales por equipo. Cada equipo debe estar directamente vinculado a una actividad, una condición de ejecución o un resultado, y su exigencia ha de ser necesaria, objetiva, razonable, proporcional y verificable. No inventes equipos, cantidades, marcas, modelos, capacidades ni características, y no añadas características innecesarias: cada una de más deja fuera a un postor sin razón.';

export const METODO_EQUIPAMIENTO_ESTRATEGICO =
  ' Esto solo corresponde en servicios y obras; si lo que se contrata son bienes, di que no corresponde establecer equipamiento estratégico. Antes de nada, determina si la ejecución lo necesita: si puede ejecutarse bien sin él, dilo y no lo establezcas. Si corresponde, precisa la relación del equipamiento, la cantidad de cada uno y DE DOS A TRES características técnicas relevantes, directamente ligadas a la función que cumplirá y que serán materia de acreditación. Cada equipo debe ser indispensable o determinante para la ejecución y su exigencia objetiva, necesaria, razonable, proporcional y verificable. No inventes equipos, cantidades, marcas, modelos, capacidades ni características técnicas, ni pongas características excesivamente específicas que restrinjan la competencia sin razón.';

export const METODO_INFRAESTRUCTURA_ESTRATEGICA =
  ' Esto solo corresponde en servicios y obras; si lo que se contrata son bienes, di que no corresponde establecer infraestructura estratégica. Antes de nada, determina si la ejecución la necesita: si puede ejecutarse bien sin infraestructura específica a cargo del contratista, dilo y no la establezcas. Si corresponde, precisa la relación de la infraestructura, la cantidad cuando corresponda y las características mínimas directamente ligadas a la función que cumplirá en la ejecución. Cada una debe ser necesaria y determinante, y su exigencia objetiva, razonable, proporcional y verificable. No inventes infraestructura, cantidades, ubicaciones, dimensiones, capacidades ni características técnicas, ni pongas condiciones excesivamente específicas que restrinjan la competencia sin razón.';

export const METODO_CAPACIDAD_LEGAL =
  ' Antes de nada, determina si la actividad objeto de esta contratación exige por norma una habilitación para poder ejercerla: si no la exige, di que no corresponde establecer este requisito. Si corresponde, señala la habilitación exigible AL PROVEEDOR y el documento que la acredita, indicando qué autoridad lo emite cuando se sepa. El requisito debe derivar de una autorización, licencia, registro o habilitación legal exigible para ejercer esa actividad, y ser necesario, objetivo, razonable, proporcional y verificable. NO son capacidad legal del proveedor, y por tanto no los pidas aquí: el Registro Nacional de Proveedores (RNP), la ficha RUC, la licencia de funcionamiento, ni las autorizaciones, licencias o permisos del personal o de los equipos, que se evalúan en el apartado que les corresponda. No inventes habilitaciones, documentos, autoridades ni vigencias; si te falta el dato indispensable, pídeselo al área usuaria con [Pendiente: qué falta].';

export const METODO_SIMILARES =
  ' Determina cuáles son los bienes o servicios similares al objeto de esta contratación. Identifica primero las características esenciales del objeto que permiten decidir la similitud, y propón VARIAS alternativas diferenciadas, no una sola: el área usuaria elegirá, modificará o descartará la que considere más representativa. Evita denominaciones genéricas o que desnaturalicen el objeto, y no incluyas prestaciones que solo compartan características accesorias o elementos aislados. La similitud se determina por la naturaleza y las características esenciales de la prestación, no porque coincidan palabras en la denominación. No inventes bienes o servicios similares que no puedan sustentarse en las características y condiciones de esta contratación.';

export const METODO_FORMACION_PERSONAL_CLAVE =
  ' Esto solo corresponde en servicios y obras; si lo que se contrata son bienes, di que no corresponde establecer la formación académica del personal clave. Antes de nada, determina si por la naturaleza, complejidad o especialidad hace falta identificar personal clave: si la prestación puede ejecutarse bien sin él, dilo y no lo establezcas. Si corresponde, precisa de cada uno: el cargo o responsabilidad en la ejecución, la profesión o formación profesional directamente vinculada a las funciones que desempeñará y el grado o título profesional cuando corresponda. Comprueba que cada personal clave sea necesario, pertinente y directamente vinculado a las actividades, responsabilidades, resultados y condiciones de ejecución, sin duplicidades ni exigencias innecesarias. No inventes cargos, responsabilidades, profesiones, grados ni títulos profesionales.';

export const METODO_EXPERIENCIA_PERSONAL_CLAVE =
  ' Antes de nada, determina si hace falta exigir experiencia al personal clave. En servicios y obras, decide si es necesaria para asegurar la adecuada ejecución. En bienes NO corresponde, salvo que el sistema de entrega sea llave en mano o llave en mano con mantenimiento y la naturaleza de la prestación lo justifique. Si no se justifica, dilo y no la establezcas. Si corresponde, precisa de cada personal clave: cargo o responsabilidad; cantidad cuando corresponda; tiempo mínimo de experiencia; cargo o función desempeñada que servirá para acreditarla; y el criterio de cómputo, según la naturaleza de la prestación. La experiencia exigida debe relacionarse directamente con sus funciones y ser necesaria, objetiva, razonable, proporcional y verificable. No inventes períodos, cargos, funciones, cantidades ni criterios de cómputo, y no exijas de más: cada año de experiencia que sobra deja fuera a un postor idóneo.';

export const METODO_CAPACITACION_PERSONAL_CLAVE =
  ' Esto solo corresponde en contrataciones de SERVICIOS. En bienes, en consultoría de obras y en ejecución de obras, di que no corresponde establecer capacitación del personal clave. Cuando corresponda, determina primero si las funciones del personal clave requieren capacitación específica adicional: si no la requieren, dilo y no la establezcas. Si corresponde, precisa de cada uno: el cargo o responsabilidad, la materia o área de capacitación directamente vinculada a las funciones que desempeñará y la cantidad mínima de horas cuando resulte necesaria. Comprueba que sea necesaria, pertinente, proporcional y ligada a sus actividades y responsabilidades. No inventes materias, áreas de capacitación, cantidades de horas ni condiciones que no estén sustentadas en lo que se te ha dado.';
