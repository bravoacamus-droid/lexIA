...
export const PLANTILLA_SERVICIOS_COMPARACION_PRECIOS: PlantillaRequerimiento = {
  ...
  secciones: [
...

    {
      ...
      subsecciones: [
        ...
        },
        {
          ...
          // cada uno con su subtítulo, como en Bienes en General.
          // Observación de César del 13/09/2026 sobre este formato:
          // "en el punto 6.5 Garantía comercial le falta los siguientes
          // subtítulos". Los textos no cambian; cambia de quién cuelgan.
          subsecciones: [
            {
              id: 'garantia_alcance',
...

    {
      ...
      bloques: [],
      // El formato los agrupa en dos: los obligatorios y los
      // adicionales, y de cada uno cuelga su requisito. La plantilla los
      // tenía sueltos. Observación de César del 13/09/2026: "el punto
      // 10 debe estar estructurado de la siguiente manera: 10.1
      // requisitos de calificación obligatorios (falta incluir) ... 10.2
      // requisitos de calificación adicionales". Igual que en Bienes en
      // General.
      subsecciones: [
        {
          ...
          subsecciones: [
          {
            ...
            // El formato la rotula con letra —A. y B.—, en una sola
            // serie que cruza de los obligatorios a los adicionales.
            numeralLiteral: true,
            ...
            bloques: [
              ...
              // Los rótulos van como título y no como etiqueta del
              // bloque: la etiqueta solo se ve mientras el apartado está
              // vacío, y en cuanto el área usuaria escribía, "Requisitos:"
              // y "Acreditación:" desaparecían del documento.
   ...
   metodo: METODO_CAPACIDAD_LEGAL,
        ...
        },
        {
          ...
          subsecciones: [
          {
            ...
            bloques: [
              // Los dos rótulos del formato. Observación de César del
              // 13/09/2026: bajo "b. Experiencia del postor en la
              // especialidad" van "- Requisitos" y "- Acreditación".
              { clase: 'titulo', texto: 'Requisitos:', nivel: 3 },
              {
