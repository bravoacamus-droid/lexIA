...
export function RequirementView({ initial }: Props) {
  ...
  async function exportToWord() {
    ...
    try {
      ...
      a.download =
        match?.[1] || `requerimiento-${initial.objeto}-${initial.anio}.docx`;
      a.click();
        ...
        <div className="space-y-5">
          <Card className="p-7 space-y-5">
            ...
            <div>
              ...
              <Textarea
                value={organoUnidad}
                onChange={(e) => setOrganoUnidad(e.target.value.slice(0, 100))}
                rows={2}
                maxLength={100}
                className="mt-1.5"
            ...
            <div>
              ...
              <Textarea
                value={actividadPoi}
                onChange={(e) => setActividadPoi(e.target.value.slice(0, 500))}
                rows={3}
                maxLength={500}
                className="mt-1.5"
